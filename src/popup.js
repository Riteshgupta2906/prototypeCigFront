  ...
  render() {
    return (
      <div id="form_bg_a">
        ...
        <label className="container_r" id="rad">
          Other
        ...
        <div id="btn_form_a" onClick={this.submit}>
          Send
        </div>
      </div>
    );
