    ...
    return (
      <div>
        ...
        <div id="sub_collab">
          ...
          series with different coorporations and industries
        </div>
        <img id="collab_bg" src={collab_bg} alt="" />
        ...
        <img id="line_a" src={line} alt="" />

        <div className="row_view">
          <div className="column_view">
        ...
        <div id="cls_subhead">
          Proident laborum culpa incididunt do cupidatat dolore dolor amet nulla
          amet est voluptate dolor Lorem. Do ipsum irure officia reprehenderit
          anim officia elit. Laborum cupidatat cillum ipsum non magna esse ipsum
          dolor.
        </div>
        <img id="cls_img" src={cls_img} alt="" />
