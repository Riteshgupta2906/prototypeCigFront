  ...
  render() {
    return (
      <div>
        ...
        <div className="row">
          {this.state.adminBody.length !== 0 &&
            this.state.adminBody.map((adm, index) => (
        ...
        <div className="row">
          {this.state.studentBody.length !== 0 &&
            this.state.studentBody.map((adm, index) => (
              <Card id={index} admin={adm} />
            ))}
        </div>
      </div>
