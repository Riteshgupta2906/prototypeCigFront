  ...
  render() {
    return (
      <div className="start">
        ...
        <div className="img1">
          <img className="imgWidth" src={img1} alt="" />
        </div>
        <div className="prob">Problem Statements</div>
        <div>
          <div className="img2">
            <img className="imgWidth" src={img2} alt="" />
          </div>
          ...
          <div onClick="/">
            ...
            <div className="V1">
              <img className="imgWidth" src={vector} alt="" />
            </div>
          </div>
          ...
          >
            ...
            <div className="v1">
              <img className="imgWidth" src={vector2} alt="" />
            </div>
          </div>
        </div>
        <div>
          <div className="img3">
            <img className="imgWidth" src={img3} alt="" />
          </div>
        ...
        <div>
          <div className="img4">
            <img className="imgWidth" src={img4} alt="" />
          </div>
        ...
        <div>
          <div className="img5">
            <img className="imgWidth" src={img5} alt="" />
          </div>
        ...
        <div className="img6">
          <img className="imgWidth" src={img6} alt="" />
        </div>
        <div className="accordian">
          {this.state.faqs.map((faq, index) => (
            <div
              className={`contentBx ${
                !this.state.editVisibles[faq.id] ? "unactive" : "active"
              }`}
              onClick={() => {
